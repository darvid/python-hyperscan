...
* ci: :ferris_wheel: fix release job conditional (again?) ([`5447005`](https://github.com/darvid/python-hyperscan/commit/544700513bc5345a1c97e17c5bded03791e23adc))

* ci: :ferris_wheel: fix check changes job in build ([`289dd1a`](https://github.com/darvid/python-hyperscan/commit/289dd1a86ac91389e4d7d2da520c216398c1a1dc))

* ci: :ferris_wheel: fix check changes job in build ([`736103c`](https://github.com/darvid/python-hyperscan/commit/736103c6ddd326d8708987bd386963982abc8c73))

* ci: :ferris_wheel: fix release [build] ([`7fdb749`](https://github.com/darvid/python-hyperscan/commit/7fdb749b86ce0c77335bd23582ce7c6db50c4637))

* ci: :ferris_wheel: move to non-deprecated GH release action ([`8e7fb15`](https://github.com/darvid/python-hyperscan/commit/8e7fb15a1c119ecf7a8c2ae85613ff052fcb9b11))

* build: :package: change dist name back to fix pypi publishing ([`3245deb`](https://github.com/darvid/python-hyperscan/commit/3245debb55bbb58119e3c8a07eb6a9e3860d7338))

* chore: update CHANGELOG.md

Signed-off-by: David Gidwani <david.gidwani@atomweight.io> ([`98bccf4`](https://github.com/darvid/python-hyperscan/commit/98bccf4a602c99c946255d30bcee281bb977f05b))
